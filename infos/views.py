...
from .filters import AboutTheProjectListFilter, TeamMemberListFilter, ProjectInstListFilter
from .forms import (
...
from .tables import TeamMemberTable, AboutTheProjectTable, ProjectInstTable
from .models import TeamMember, AboutTheProject, ProjectInst
