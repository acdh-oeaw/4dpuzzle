...
class Metadata(models.Model):
    ...
    license = models.CharField(
        max_length=300, blank=True, help_text="A license applied to the vocabulary"
    )
...
class SkosConceptScheme(models.Model):
    ...
    dc_title = models.CharField(max_length=300, blank=True, verbose_name="dc:title")
    dc_title_lang = models.CharField(
        max_length=3, blank=True, verbose_name="dc:title language", default=DEFAULT_LANG
    )
...
class SkosCollection(models.Model):
    ...
    skos_example = models.CharField(
        max_length=500, blank=True, verbose_name="skos:example"
    )
