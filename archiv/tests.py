...
class ArchivTestCase(TestCase):
    ...
    def test_007_arche_view(self):
        url = reverse(
            "archeutils:qs_as_arche_graph",
            kwargs={"app_name": "archiv", "model_name": "fotosgescannt"},
        )
        rv = client.get(url)
        self.assertEqual(rv.headers["Content-Type"], "text/turtle")
